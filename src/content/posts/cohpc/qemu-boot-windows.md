---
title: "Boot Windows on QEMU 9.2.0"
pubDatetime: 2025-10-09T20:33:41+08:00
description: "I tries to boot Windows on QEMU 9.2.0. This is how the process goes."
tags:
  - cohpc
---
...
Script explained:
1. `-net user,hostname=windows` enables user network device, meaning we are using host network. Normal build of QEMU or QEMU installed by distribution package manager might not have user network enabled. Refer to [this chapter](/posts/cohpc/build-modules-on-hpc-cluster) for how to build a QEMU that fulfills requirement.
